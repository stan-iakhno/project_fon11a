...
colnames(otu.top6.df)<- paste0(tax.top6.df$Phylum)
...
colnames(otu.top6.df)<-sub("p__*", "", colnames(otu.top6.df))
...
otu.table.top6.df.long <-melt(data = otu.table.top6.df, id.vars = c(7:9))
